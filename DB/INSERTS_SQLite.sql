...
-- INSERT INTO Categoria (CategoriaId, Titulo)  
...
INSERT INTO Pedido (Quantidade, Estado, PedidoId, Data_Criacao, Comentario, Data_Modificacao, Titulo, Descricao, FeitoPor)  
    VALUES (1, 10, 1, '2020-03-02 09:00:00', 'Muito Obrigado!!!', '2020-03-02 10:00:00', 'Shampoos', 'preiso de um shampoo, quero tomar banho', 1);

INSERT INTO Pedido (Quantidade, Estado, PedidoId, Data_Criacao, Comentario, Data_Modificacao, Titulo, Descricao, FeitoPor)  
    VALUES (2, 20, 2, '2020-02-01 12:00:00', '', '2020-02-01 16:00:00', 'Blusa', 'Necessito de duas blusas de frio', 4);

INSERT INTO Pedido (Quantidade, Estado, PedidoId, Data_Criacao, Comentario, Data_Modificacao, Titulo, Descricao, FeitoPor)  
    VALUES (1, 30, 3, '2020-04-27 04:00:00', '', '2020-04-28 02:00:00', 'Pedido de Prato','Aguem pode me doar um prato', 5);

INSERT INTO Pedido (Quantidade, Estado, PedidoId, Data_Criacao, Comentario, Data_Modificacao, Titulo, Descricao, FeitoPor)  
    VALUES (1, 10, 4, '2020-03-02 06:00:00', '', '2020-03-02 10:00:00', 'Educação física', 'preciso de um tenis, para aula de educação fisica',1);

INSERT INTO Item (foto, ItemId, Titulo, Data_Modificacao, Data_Criacao, Descricao, CategoriaId, PedidoId)  
...
INSERT INTO Usuario (Telefone, Documento, Email, Senha, Nome, UsuarioId, Data_Modificacao, Foto_usuario, Data_Criacao)  
    VALUES (1998100000, 
    'images\IMG01.PNG', 
...
INSERT INTO Beneficiario (Interno, RA, BeneficiadoId, UsuarioId)  
    VALUES (1, 59000, 1, 1);
...
-- INSERT INTO Acessa (UsuarioId, PedidoId)  
--     VALUES (1, 1)
...
-- INSERT INTO Seleciona (ItemId, PedidoId)  
--     VALUES (1, 1)
...
INSERT INTO Mediador (MediadorId, RA, UsuarioId)  
    VALUES (1, 58000, 2);
...
INSERT INTO Doador (DoadorId, UsuarioId)  
    VALUES (1, 3);
